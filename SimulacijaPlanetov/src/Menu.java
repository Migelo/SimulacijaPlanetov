...
public class Menu extends JMenuBar implements ActionListener{
	...
	public void actionPerformed(ActionEvent a) {
		if (a.getActionCommand()=="Osoncje"){
			...
			Planet merkur = new Planet(merkurPolozaj, merkurHitrost, prazna, merkurMasa/sonceMasa, "merkur", 5, "white");
			...
			Planet venera = new Planet(veneraPolozaj, veneraHitrost, prazna, veneraMasa/sonceMasa, "venera", 10, "yellow");
			...
			Planet jupiter = new Planet(jupiterPolozaj, jupiterHitrost, prazna, jupiterMasa/sonceMasa, "jupiter", 10, "yellow");
			...
			Planet saturn = new Planet(saturnPolozaj, saturnHitrost, prazna, saturnMasa/sonceMasa, "saturn", 10, "yellow");
			...
			Planet uran = new Planet(uranPolozaj, uranHitrost, prazna, uranMasa/sonceMasa, "uran", 10, "yellow");
			...
			Planet neptun = new Planet(neptunPolozaj, neptunHitrost, prazna, neptunMasa/sonceMasa, "neptun", 10, "yellow");
			...
			Planet planetic = new Planet(planeticPolozaj, planeticHitrost, prazna, planeticMasa/sonceMasa , "planetic", 10, "yellow");
			
			Tocka planetic1Polozaj = new Tocka(0, 5, 0);
			Tocka planetic1Hitrost = new Tocka (-.8, 0, 0);
			double planetic1Masa = 6*Math.pow(10, 26);
			Planet planetic1 = new Planet(planetic1Polozaj, planetic1Hitrost, prazna, planetic1Masa/sonceMasa , "planetic1", 10, "yellow");
			
			Tocka planetic2Polozaj = new Tocka(0, -1.2, 0);
			Tocka planetic2Hitrost = new Tocka (1.1, 0, 0);
			double planetic2Masa = 3*Math.pow(10, 26);
			Planet planetic2 = new Planet(planetic2Polozaj, planetic2Hitrost, prazna, planetic2Masa/sonceMasa , "planetic2", 10, "yellow");
